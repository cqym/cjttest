...
<body>
	<div class="main">
		...
		<table border="1" width="100%" class="tab">
			...
			<c:forEach var="entity" items="${goods}">
				<tr>
					...
					<td>${entity.id}</td>
					<td>${entity.name}</td>
					<td><img src="<c:url value="/static/images/${entity.picture}"/>" height="40"/></td>
					<td>${entity.price}</td>
					<td>
		...
		<!--分页 -->
		<script type="text/javascript" src="<c:url value="/static/js/jQuery/jquery-2.1.4.min.js"/>" ></script>
