...
(function ($) {
	$.vakata.context = {
		...
		parse	: function (s, is_callback) {
			...
			str += "<ul class='dropdown-menu'>"; // weixiao: add bootstrap dropdown style
	...
	$(function () {
	    /* weixiao: Remove context menu style, apply bootstrap dropdown style. */
		var css_string = '' + 
			'#vakata-contextmenu { display:block; visibility:hidden; left:0; top:-200px; position:absolute; z-index:10000; /*margin:0; padding:0; min-width:100px; background:#ebebeb; border:1px solid silver; *width:180px; */} ' +
			//'#vakata-contextmenu ul { min-width:140px; *width:100px; } ' + 
			'#vakata-contextmenu ul, #vakata-contextmenu li { /*margin:0; padding:0; */list-style-type:none; display:block; } ' + 
			//'#vakata-contextmenu li { line-height:20px; min-height:20px; position:relative; padding:0px; } ' + 
			//'#vakata-contextmenu li a { padding:1px 6px; line-height:17px; display:block; text-decoration:none; margin:1px 1px 0 1px; } ' + 
			'#vakata-contextmenu li ins { display:none; /*float:left; width:16px; height:16px; text-decoration:none; margin-right:2px; */} ' + 
